...
WITH required_columns AS (
  SELECT * FROM (VALUES
    ...
    ('purchase_orders','shipping_estimate'),
    ('purchase_orders','other_fees'),
    ('purchase_orders','items_subtotal'),
    ('purchase_orders','total_cost_aed'),
    ('purchase_orders','paid_amount_aed'),
    ('purchase_orders','supplier_owed_aed'),
    ...
    ('purchase_order_payments','amount_in_po_currency'),
